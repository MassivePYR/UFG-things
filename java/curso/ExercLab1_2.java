...
public class ExercLab1_2 {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Curso 1: " + curso1.nome + ", " + curso1.cargaHoraria + ", " + curso1.professor + ", " + curso1.turno);
        System.out.println(
                "Curso 2: " + curso2.nome + ", " + curso2.cargaHoraria + ", " + curso2.professor + ", " + curso2.turno);
        System.out.println(
                "Curso 3: " + curso3.nome + ", " + curso3.cargaHoraria + ", " + curso3.professor + ", " + curso3.turno);
        System.out.println(
                "Curso 4: " + curso4.nome + ", " + curso4.cargaHoraria + ", " + curso4.professor + ", " + curso4.turno);
