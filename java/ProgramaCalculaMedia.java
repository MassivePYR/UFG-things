...
public class ProgramaCalculaMedia {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Média do(a) Aluno(a) " + nomeAluno1 + " (Matrícula - " + matAluno1 + ") = "
				+ df.format(mediaAluno1) + (mediaAluno1 > 7 ? " Aprovado" : " Reprovado"));
		JOptionPane.showMessageDialog(null, "Média do(a) Aluno(a) " + nomeAluno2 + " (Matrícula - " + matAluno2 + ") = "
				+ df.format(mediaAluno2) + (mediaAluno2 > 7 ? " Aprovado" : " Reprovado"));
		JOptionPane.showMessageDialog(null, "Média do(a) Aluno(a) " + nomeAluno3 + " (Matrícula - " + matAluno3 + ") = "
				+ df.format(mediaAluno3) + (mediaAluno3 > 7 ? " Aprovado" : " Reprovado"));
		JOptionPane.showMessageDialog(null, "Média do(a) Aluno(a) " + nomeAluno4 + " (Matrícula - " + matAluno4 + ") = "
				+ df.format(mediaAluno4) + (mediaAluno4 > 7 ? " Aprovado" : " Reprovado"));

		JOptionPane.showMessageDialog(null, "Média Geral = " + df.format(mediaGeral));
	}

}
// if mediaAluno1>7 then "Aprovado" else "Reprovado"
